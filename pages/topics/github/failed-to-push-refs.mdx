---
title: Failed To Push Some Refs
authors: ["Manoj Marmat"]
---

# Failed to push some refs to git_repo

When we are trying to push changes to a Git branch but your local branch has [diverged](/sub-topics/diverge) from the remote branch, meaning that there are changes on the remote branch that you do not have locally.
